# 🚀 Nikhil Narayan Gathade — Portfolio Deployment Guide

**Email:** nikhilgathade59@gmail.com | **Phone:** +917620843938 | **Location:** Pune, Maharashtra
**LinkedIn:** [linkedin.com/in/nikhil-gathade-0a8395239](https://linkedin.com/in/nikhil-gathade-0a8395239) | **GitHub:** [github.com/Nikhil221003](https://github.com/Nikhil221003)
...
git remote add origin https://github.com/Nikhil221003/portfolio.git
git push -u origin main
```
3. Go to repo → **Settings** → **Pages**
4. Source: `Deploy from a branch` → Branch: `main` → Folder: `/ (root)`
5. Save → Live in ~2 minutes at `https://Nikhil221003.github.io/portfolio`
...
3. **Live in 30 seconds** with a URL like `https://nikhil-portfolio.netlify.app`
...
| Resume PDF | Replace `assets/Nikhil_Gathade_Resume.pdf` |
...
<div class="about-avatar">
  <div class="avatar-initials">NG</div>
</div>

<!-- Replace with: -->
<div class="about-avatar">
  <img src="assets/profile.jpg" alt="Nikhil Narayan Gathade"
...
| Platform    | Link                                                                          |
|-------------|-------------------------------------------------------------------------------|
| 💼 LinkedIn  | [linkedin.com/in/Nikhil221003](https://linkedin.com/in/Nikhil221003)          |
