...
const PROJECTS = [

  {
    ...
    github: 'https://github.com/Nikhil221003/FinSight-',
    modal: {
...

  {
    ...
    github: 'https://github.com/Nikhil221003/EmployeeHub-main',
    modal: {
...
const METRICS = [
  ...
  { icon: '📊', val: 284, suffix: 'K', label: 'Records Analyzed', duration: 1400 },
...
const words = ['Data Enthusiast', 'Data Enthusiast', 'Turning Data into Insights'];
let wordIndex = 0;
let charIndex = 0;
...
contactForm.addEventListener('submit', async (e) => {
  ...
  // ─────────────────────────────────────────────
  const EMAILJS_SERVICE_ID = 'service_7oqs88p';   // ✅ Connected — nikhilgathade59@gmail.com
  ...
  try {
    ...
    if (EMAILJS_SERVICE_ID === 'YOUR_SERVICE_ID') {
      ...
      formFeedback.textContent = '❌ Something went wrong. Please email me directly at nikhilgathade59@gmail.com';
    }
...
console.log('%c👋 Hey recruiter! Built by Nikhil Narayan Gathade — Let\'s connect.',
